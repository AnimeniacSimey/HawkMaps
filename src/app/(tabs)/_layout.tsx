/**
 * HawkMaps · src/app/(tabs)/_layout.tsx
 *
 * Tab navigator (Expo Router file-based routing). Only reachable when
 * signed in — see the auth guards in src/app/_layout.tsx.
 *
 * ─────────────────────────────────────────────────────────────────────────
 * HOW TO ADD A NEW TAB
 * ─────────────────────────────────────────────────────────────────────────
 * 1. Create  src/app/(tabs)/your-screen.tsx  (export a default React component).
