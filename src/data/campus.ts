...
export const BUILDINGS: Building[] = [
  ...
  { id: "schlegel-building", name: "Schlegel Building", code: "SB", aliases: ["sb", "schlegel", "schlegel building"], roomPrefixes: ["sb"], street: "75 University Ave W (main campus)", hours: { open: "07:00", close: "23:00" }, contains: "academic lectures plus Enrolment Services - Service Laurier, Recruitment & Admissions and the Registrar's Office", connected: true, lat: 43.47342, lng: -80.53031 },
  { id: "science-building", name: "Science Building", code: "N", aliases: ["n", "sci", "science", "science building"], roomPrefixes: ["n"], street: "75 University Ave W (main campus)", hours: { open: "07:00", close: "23:00" }, contains: "the Faculty of Science (Chemistry, Computer Science, Physics, Photonics, Psychology), labs, lecture halls, a Tim Hortons and atrium study space", connected: true, lat: 43.47355, lng: -80.5248 },
  ...
  { id: "athletic-complex", name: "Athletic Complex", code: "AC", aliases: ["ac", "athletic complex", "athletics", "gym"], roomPrefixes: [], street: "75 University Ave W (main campus)", hours: { open: "06:00", close: "23:00" }, contains: "a large fitness centre, three gymnasiums, squash courts, varsity teams and intramurals", connected: false, lat: 43.47526, lng: -80.5255 },
  ...
  { id: "macdonald-house-residence", name: "Macdonald House Residence", code: "MC", aliases: ["mac house", "macdonald", "macdonald house", "macdonald house residence", "mc"], roomPrefixes: [], street: "Main campus residence", hours: { open: "00:00", close: "00:00" }, contains: "a student residence (resident card access)", connected: false, lat: 43.47377, lng: -80.52801 },
  ...
  { id: "willison-hall-residence", name: "Willison Hall Residence", aliases: ["willison", "willison hall", "willison hall residence"], roomPrefixes: [], street: "Main campus residence", hours: { open: "00:00", close: "00:00" }, contains: "a student residence (resident card access)", connected: false, lat: 43.4737, lng: -80.52678 },
];
